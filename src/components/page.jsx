...
import { Home, Bell, ShoppingCart, User, Scan, Edit3, FileType, Bot } from "lucide-react"
import "./styles.css"
  ...
  return (
    <div className="app-container">
      ...
      <nav className="bottom-nav">
        ...
        <Bell className="nav-icon" onClick={handleBellClick} />
